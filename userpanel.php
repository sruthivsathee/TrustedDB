...
// Get all the data from the "account" table
	$result = mysql_query("SELECT * FROM account where email='$_SESSION[user]'") or die(mysql_error());  
  
	echo "<table  id='select_table'>";
	echo "<tr> <th>Name</th> <th>Address</th> <th>DOB</th> <th>Mobile</th><th>E Mail</th>".
	     "<th>IMEI</th><th>KEY NO</th></tr>";
//<th>Del</th>
// keeps getting the next row until there are no more to get and print in table form
